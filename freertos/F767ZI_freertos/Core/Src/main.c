...
/* Creating custom tasks without CubeMX */
osThreadId_t taskHandle03;
...
int main(void)
{
  ...
  /* Creation of task03 */
  //taskHandle03 = osThreadNew(task03_init, NULL, &task03_attributes);
...
//	  /* Resume default task if count == 7 */
//	  if (count == 8)
//	  {
